...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <%
		...
		applys =AbroadApplyRecorddao.getMyApply(user.getUserId());
	...
	<body>
		...
		<div>
			...
			<ul class="nav nav-tabs " role="tablist">
				<li role="presentation" class="dropdown ">
					...
					<ul class="dropdown-menu">
         			   <li><a href="#home" aria-controls="home" role="tab" data-toggle="tab">个人出国信息查询</a></li>
        			   <li><a id="teachercompleteinform.jsp" href="">全体出国信息查询</a></li>
         			</ul>
			...
			<div class="tab-content">
				<!-- headline个人出国内容查询表 dependence Apply,Applydao-->
				...
				<!--tail line 个人出国内容查询表 dependence Apply,Applydao-->
		...
		<script>
		function disable(){
        	var hf = document.getElementById("teachercompleteinform.jsp");
        	var  a ="<%=user.getRole()%>";
        	if(a!=3){
        	hf.setAttribute('href',"teachercompleteinform.jsp");        		
        	}
        }
        disable();
		</script>
